...
- `createRouteView` / `createLazyRouteView` — bind a route to a component (with optional lazy loading), plus `otherwise` and `loading` components for the closed and pending states.
