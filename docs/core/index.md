...
The core package of effector/router Router provides the fundamental routing primitives powered by [Effector](https://effector.dev).

## Overview

`@effector/router` is the foundation of effector/router Router. It provides:
...
```bash
npm install @effector/router effector
```
...
effector/router Router provides full type safety:
