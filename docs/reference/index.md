...
- [React](/react/) - `@effector/router-react` bindings
- [Vue](/vue/) - `@effector/router-vue` bindings (β)
- [Solid](/solid/) - `@effector/router-solid` bindings (β)
- [React Native](/react-native/) - `@effector/router-react-native` bindings (β)
- [Web Link contract matrix](/reference/link-matrix) - cross-framework `Link` behavior
